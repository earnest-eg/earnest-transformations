...
Grocery, household, electronics, and general retail data.
...
- **Runtime:** Python 3.11+
- **Detected stack:** Playwright, Beautiful Soup, HTTPX, Requests
